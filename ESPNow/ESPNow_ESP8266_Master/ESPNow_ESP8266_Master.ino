/*
 * Source: https://github.com/0015/ThatProject/blob/master/ESPNOW/ESPNOW_ESP8266_MASTER_ESP32_SLAVE/ESPNOW_ESP8266_MASTER/ESPNOW_ESP8266_MASTER.ino
 */
...
void sendData() {
    ...
    sensordata.temp = 27;
    sensordata.hum = 80;
    sensordata.readingId++;
  
  for (int i = 0; i < SlaveCnt; i++) {
    u8 *peer_addr = slaves[i].peer_addr;
    if (i == 0) { // print only for first slave
      Serial.print("Sending data ");
//      Serial.println(sensordatata);
    }
    int result = esp_now_send(peer_addr, (uint8_t *)&sensordata, sizeof(sensordata));
